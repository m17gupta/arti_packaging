      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute bottom-8 left-8 bg-white/90 backdrop-blur border border-[#E5DED5] px-6 py-4">
              <p className="font-serif text-4xl font-light text-[#C9A84C]">6+</p>
              <p className="text-xs tracking-widest uppercase text-[#7A6E62] mt-1">
          ...
          >
            ...
            <div className="space-y-5 mt-8">
              <p className="text-[#7A6E62] leading-relaxed text-base">
            ...
            <div className="grid grid-cols-3 gap-4 mt-10 pt-10 border-t border-[#E5DED5]">
              {values.map((v) => (
                <div key={v.label} className="text-center">
                  <div className="w-8 h-px bg-[#C9A84C] mx-auto mb-3" />
                  <p className="text-[#1A1208] text-sm font-medium">{v.label}</p>
                  <p className="text-[#7A6E62] text-xs mt-1">{v.desc}</p>
                </div>
              ))}
            </div>
          </motion.div>
