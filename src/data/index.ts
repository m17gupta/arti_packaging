...
export const productCategories: ProductCategory[] = [
  ...
  },
  {
    ...
    description: 'Our signature artisan gift hammers — a unique and memorable keepsake for special occasions.',
    icon: '🔨',
  ...
  },
  {
    ...
    description: 'Thoughtfully assembled wellness hampers featuring premium self-care and lifestyle products.',
    icon: '🌿',
