...
function CategoryCard({ category, index }: { category: ProductCategory; index: number }) {
  return (
    <motion.div
      ...
      whileHover={{ y: -6 }}
      className="group relative overflow-hidden cursor-pointer bg-white border border-[#E5DED5] hover:border-[#C9A84C]/50 transition-all duration-500 shadow-sm hover:shadow-md"
    >
      ...
      <div className="p-6">
        <div className="flex items-start justify-between mb-3">
          <h3 className="font-serif text-xl font-light text-[#1A1208] group-hover:text-[#C9A84C] transition-colors duration-300">
            {category.name}
          </h3>
        ...
        <p className="text-[#7A6E62] text-sm leading-relaxed mb-4">
...
export function Collections() {
  return (
    <section id="collections" className="py-28 px-6 bg-[#F5F2EE]">
